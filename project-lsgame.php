    ...
    <!-- Project Header -->
        <section class="project-header">
            <div class="grid-2col mar10-bot">
                <div class="full">
                    <h1 class="header-title">Lifespan Game</h1>
                </div>
                <div class="full">
                    <h4 class="header-catagories">Art Direction, Game UI, Graphic Design</h4>
                </div>
            </div>
        ...
        <section class="project-content">
            ...
            <div class="full copy-container pad60">
                <div class="full">
                    <h3 class="text-gold">Accessible, Responsive UI</h3>
                </div>
                <div class="full">
                    <p class="text-grey mar15-top">
